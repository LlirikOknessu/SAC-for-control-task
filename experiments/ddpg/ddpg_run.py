...
if __name__ == '__main__':
    ...
    ddpg = DDPG(alpha=neural_network_params['alpha'], beta=neural_network_params['alpha'], batch_size=general_params['batch_size'], input_dims=general_params['input_dims'])
