...
from src.libs.dvc_utils import parser_args_for_sac, run_learning, set_connector, passing_between_episodes_on_stand
...
if __name__ == '__main__':
    ...
    additional_params = params_all['sac_stand_params'].get('additional_params')
    general_params = params_all['sac_stand_params'].get('general_params')
    neural_network_params = params_all['sac_stand_params'].get('neural_network_params')
    experiment_params = params_all['sac_stand_params'].get('experiment_params')
    ...
    for num, param_sample in enumerate(params_grid):
        ...
        load_model_path = input_model_path / (history_path.name + f'_{num}')
        ...
        sac.load_model(load_model_path.parent, load_model_path.name)
